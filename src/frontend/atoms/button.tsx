// #region HEADER
// Module: button
// Atom component for styled interactive buttons
// #endregion HEADER
...
// #region FUNCTIONS
// Renders a styled button with primary or ghost variant
const F_Button: FC<ButtonProps> = ({ variant: p_variant = 'primary', className: p_class_name = '', children: p_children, ...p_rest }) => {
    return (
        <button
            className={`
